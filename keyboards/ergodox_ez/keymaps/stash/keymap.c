...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ergodox_pretty(
    KC_CVVV,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TG(_QWERTY),                                    TT(_FNUM),      KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           MEH(KC_M),
  ...
  [_QWERTY] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTRL,       KC_LALT,        _______,        _______,        KC_GRAVE,                                                                                                       _______,        _______,        _______,        _______,        KC_RCTRL,
                                                                                                    KC_DELETE,      KC_INSERT,      KC_HOME,        KC_END,
                                                                                                                    KC_LALT,        KC_PGUP,
                                                                                    KC_SPACE,       KC_ENTER,       KC_LCTRL,       KC_PGDN,        KC_KP_ENTER,    KC_KP_0
  ),
  [_FNUM] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,      KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_ENTER,                                       KC_LEAD,        KC_VOLD,       KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_MINUS,    KC_SMIN,
    KC_SuAT,        ST_MACRO_Sleep, ST_MACRO_Sleep, KC_NO,          KC_GRAVE,                                                                                                      KC_KP_0,        KC_KP_DOT,      KC_KP_DOT,      KC_KP_PLUS,     TT(_ADJUST),
  ...
  [_ADJUST] = LAYOUT_ergodox_pretty(
    NK_ON,          NK_OFF,         KC_NO,          KC_NO,          KC_NO,          WKSP_DEL,       KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          EEP_RST,        RESET,
    ...
    _______,        KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       _______,
                                                                                                    KC_MS_BTN3,     CG_SWAP,        _______,        _______,
                                                                                                                    _______,        KC_RALT,
                                                                                    KC_MS_BTN1,     KC_MS_BTN2,     CG_NORM,        KC_RCTL,        _______,        KC_CAPS
  ),
