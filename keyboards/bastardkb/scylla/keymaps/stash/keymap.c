...
enum layer_names { _WINDOWS, _MAC, _GAME, _R_HAND, _L_HAND, _BOTH_HANDS };

enum custom_keycodes { SET_WIN = SAFE_RANGE, SET_MAC, RGB_RLD, SET_GAM };
...
[_GAME] = LAYOUT_split_4x6_5(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,        KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                             KC_LALT, KC_SPC,  KC_BSPC,     KC_ENT, KC_RSFT, OSM(MOD_MEH),
                                  KC_LCTL, TT(_L_HAND),     TT(_R_HAND), KC_RGUI
  ),
...
[_R_HAND] = LAYOUT_split_4x6_5(
  ...
  _______, KC_GRV,  KC_TILD, KC_LBRC, KC_RBRC, KC_ENT,      XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
                             KC_LALT, KC_LCTL, KC_DEL,      KC_INS,  CW_TOGG, _______,
                                      KC_LGUI, _______,     _______, KC_MENU
  ),
...
[_BOTH_HANDS] = LAYOUT_split_4x6_5(
  QK_BOOT, QK_REBOOT,EE_CLR, XXXXXXX, SET_GAM, SET_WIN,     SET_MAC, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSLS, KC_NUM,
    ...
    switch (keycode) {
        ...
        case SET_GAM:
            if (record->event.pressed) {
                set_single_persistent_default_layer(keycode == SET_WIN ? _WINDOWS : _GAME);
